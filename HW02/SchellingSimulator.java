...
public class SchellingSimulator {
	 ...
	 */
	private int population = (int)(width * height * 0.95);
	 ...
	 */
		...
		for (int i = 0; i < population; i++) {
			...
			int g1 = (int) (c1 * population);
			int g2 = (int) (c2 * population);
			int g3 = (int) (c3 * population);

			if (i < g1) {
			    grid[xChoice][yChoice] = 1;
			} else if (i < (g1 + g2)) {
			    grid[xChoice][yChoice] = 2;
			} else if (i < g1 + g2 + g3) {
			    grid[xChoice][yChoice] = 3;
			} else {
			    grid[xChoice][yChoice] = 4;
			}
	...
	public static void main(String[] args) {
		SchellingSimulator sch = new SchellingSimulator(1, 4, (int)(50*50*0.92), 3, 50, 50);
